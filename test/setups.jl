...
const RECURRENT_CELLS = [
    ...
    (:coRNNCell,
        ...
        [:use_bias, :use_recurrent_bias, :use_cell_bias, :train_state, :train_memory]),
    (:FastGRNNCell,
    ...
    (:NBRCell,
        ...
        [:use_bias, :use_recurrent_bias, :train_state]),
    (:OriginalLSTMCell,
        (; kwargs...) -> OriginalLSTMCell(3 => 5; kwargs...),
        [:use_bias, :use_recurrent_bias, :train_state, :train_memory]),
    (:PeepholeLSTMCell,
        (; kwargs...) -> PeepholeLSTMCell(3 => 5; kwargs...),
        [:use_bias, :use_recurrent_bias, :use_peephole_bias, :train_state, :train_memory]),
    (:RANCell,
        (; kwargs...) -> RANCell(3 => 5; kwargs...),
        [:use_bias, :use_recurrent_bias, :train_state, :train_memory]),
    (:RHNCell,
        (; kwargs...) -> RHNCell(3 => 5; kwargs...),
