...
LuxRecurrentLayers.jl extends [Lux.jl](https://lux.csail.mit.edu/stable/)
...
The package offers multiple layers for [Lux.jl](https://lux.csail.mit.edu/stable/).
...
| [**NAS**](https://arxiv.org/abs/1611.01578) | arXiv 2016 | – |
